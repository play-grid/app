    ...
    <div className="stat-clash-shell px-4 py-6 md:px-6">
      <div className="mx-auto max-w-5xl space-y-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-4xl font-bold tracking-tight">{t('statClashGame.lobby.steps.reviewSolo')}</h1>
        ...
        <Card className="p-6 space-y-4">
          <div className="space-y-2">
            <div className="flex justify-between">
              ...
              <span className="font-semibold">{t('statClashGame.lobby.mode.solo')}</span>
            </div>
            <div className="flex justify-between">
