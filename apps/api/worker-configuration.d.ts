/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: b0f904f8dbb2ed6e0ec98846abc92feb)
// Runtime types generated with workerd@1.20260701.1 2025-09-01 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	...
	AI: Ai;
	ASSETS: Fetcher;
	ALLOWED_ORIGINS: "https://staging.guess-logo.pages.dev,https://games.mohadalaa.com" | "https://playgrid.mohdalaa.com" | "http://localhost:5173,http://localhost:4173,https://guess-logo.pages.dev,https://games.mohadalaa.com,https://playgrid.mohadalaa.com,https://staging.playgrid.mohdalaa.com";
	NODE_ENV: string;
	TMDB_API_KEY: string;
	LOGO_DEV_API_KEY: string;
	ALL_SPORTS_API_KEY: string;
	...
	workersSCRIPTSGITHUB: string;
	twelvedata: string;
	GAME_SESSION: DurableObjectNamespace<import("./src/app").GameSessionObject>;
	VITE_PUBLIC_POSTHOG_HOST?: "https://us.i.posthog.com";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/app");
		durableNamespaces: "GameSessionObject";
	}
	interface StagingEnv {
		...
		AI: Ai;
		ASSETS: Fetcher;
		ALLOWED_ORIGINS: "https://staging.guess-logo.pages.dev,https://games.mohadalaa.com";
		NODE_ENV: string;
		TMDB_API_KEY: string;
		LOGO_DEV_API_KEY: string;
		ALL_SPORTS_API_KEY: string;
	...
	interface ProductionEnv {
		...
		AI: Ai;
		ASSETS: Fetcher;
		ALLOWED_ORIGINS: "https://playgrid.mohdalaa.com";
		VITE_PUBLIC_POSTHOG_HOST: "https://us.i.posthog.com";
		NODE_ENV: string;
		TMDB_API_KEY: string;
		LOGO_DEV_API_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "NODE_ENV" | "TMDB_API_KEY" | "LOGO_DEV_API_KEY" | "ALL_SPORTS_API_KEY" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_KV_API_TOKEN" | "CLOUDFLARE_D1_TOKEN" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_R2_TOKEN" | "CLOUDFLARE_R2_ACCESS_KEY_ID" | "CLOUDFLARE_R2_SECRET_ACCESS_KEY" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "APP_NAME" | "LOG_LEVEL" | "API_URL" | "POSTHOG_PUBLIC_KEY" | "POSTHOG_HOST" | "R2_PUBLIC_URL" | "workersSCRIPTSGITHUB" | "twelvedata" | "VITE_PUBLIC_POSTHOG_HOST">> {}
}
