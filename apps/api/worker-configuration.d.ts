/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: e8edae414693ea0654e0d6e30069b67f)
// Runtime types generated with workerd@1.20250924.0 2025-09-01 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		ALLOWED_ORIGINS: "http://localhost:5173,http://localhost:4173,https://guess-logo.pages.dev";
		NODE_ENV: string;
		APP_NAME: string;
		TMDB_API_KEY: string;
		...
		QUESTIONS_KV_ID: string;
		BETTER_AUTH_URL: string;
		BETTER_AUTH_SECRET: string;
		GAME_ROOM: DurableObjectNamespace<import("./src/app").GameRoomDurableObject>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "NODE_ENV" | "APP_NAME" | "TMDB_API_KEY" | "LOGO_DEV_API_KEY" | "ALL_SPORTS_API_KEY" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_KV_API_TOKEN" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN" | "QUESTIONS_KV_ID" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET">> {}
}
