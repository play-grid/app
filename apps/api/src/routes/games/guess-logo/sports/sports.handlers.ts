...
import type { GetAllSportTeamsInRegionRoute, GetSportLeaguesRoute, GetSportRegionsRoute, GetSportTeamsRoute } from './sports.routes';
import type { AppRouteHandler } from '@/lib/types';
import { shuffleArray } from '@guess-logo/shared/utils';
import * as HttpStatusCodes from 'stoker/http-status-codes';
import { getAllTeamsInRegion, getLeaguesInRegion, getSportRegions as getSportRegionsService, getTeamsInLeague,
