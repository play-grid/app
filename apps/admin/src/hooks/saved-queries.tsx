 ...
 */
export function extractValidSavedQueries(savedQueries: SavedQuery[]) {
 ...
 */
export function areValidSavedQueries(savedQueries: SavedQuery[]) {
  if (
 ...
 */
export function isValidSavedQuery(savedQuery: SavedQuery) {
  if (
    savedQuery.label
