  ...
  return (
    ...
    >
      <div className={cn('rounded-md border', className)}>
        <Table>
          <DataTableRenderContext value="header">
      ...
      <DataTableRenderContext value="columnsSelector">
 ...
 */
function reorderChildren(children: ReactNode, columnRanks: number[]) {
  return Children.toArray(children).reduce((acc: ReactNode[], child, index) => {
