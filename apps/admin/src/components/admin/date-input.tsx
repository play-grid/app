...
import { FieldTitle, useEvent, useInput, useResourceContext } from 'ra-core';
 ...
 */
function convertDateToString(value: Date) {
 ...
 * defaultFormat(''); // null
 */
function defaultFormat(value: string | Date | number) {
