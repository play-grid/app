import type { RaRecord, UseFieldValueOptions, UseListOptions } from 'ra-core';
import type { ReactNode } from 'react';
import { ListContextProvider, useFieldValue, useList } from 'ra-core';
 ...
 * );
 */
export function ArrayField<RecordType extends RaRecord = RaRecord>(props: ArrayFieldProps<RecordType>) {
