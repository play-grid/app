 ...
 * );
 */
export function ListGuesser<RecordType extends RaRecord = RaRecord>(props: Omit<ListProps, 'children'> & { enableLog?: boolean }) {
  const {
    debounce,
...
function ListViewGuesser(props: Omit<ListViewProps, 'children'> & { enableLog?: boolean }) {
