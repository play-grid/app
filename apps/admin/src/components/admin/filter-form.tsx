...
function sanitizeRestProps({
  ...
  resource: _resource,
  ...props
}: Partial<FilterFormBaseProps> & { hasCreate?: boolean }) {
  return props;
}
...
function isEmptyValue(filterValue: any): boolean {
...
export function FilterButtonMenuItem({ ref, ...props }: FilterButtonMenuItemProps & { ref?: React.RefObject<HTMLDivElement | null> }) {
